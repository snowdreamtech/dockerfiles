...
[![dockeri.co](https://dockeri.co/image/snowdreamtech/nginx)](https://hub.docker.com/r/snowdreamtech/nginx)
...
* 1.19.10-alpine, mainline-alpine, 1-alpine, 1.19-alpine, alpine
